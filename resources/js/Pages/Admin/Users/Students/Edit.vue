...
const submit = () => {
    form.put(`/admin/users/students/${props.student.id}`);
};
</script>

<template>
    <AdminLayout>
        <Head title="Modify Candidate" />
        ...
        <div class="mx-auto max-w-7xl pb-24">
            <div class="space-y-6 sm:space-y-10">
                ...
                <nav class="flex items-center gap-2 text-xs font-medium text-gray-500">
                    ...
                    <span class="text-gray-800 font-medium">Edit Details</span>
                </nav>

                <!-- Page Header -->
                <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        <h1 class="text-2xl font-semibold text-gray-800">Edit Candidate Details</h1>
                        <p class="mt-1 text-sm text-gray-500">Ref #{{ student.id.substring(0, 8) }} • Update profile and placement information</p>
                    </div>
