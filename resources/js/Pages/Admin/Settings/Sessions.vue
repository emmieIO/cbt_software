            ...
            <div v-if="isModalOpen" class="fixed inset-0 z-[60] flex items-center justify-center p-4">
                ...
                <div class="animate-in zoom-in-95 relative w-full max-w-md rounded-xl border border-gray-200 bg-white p-6 shadow-lg">
                    ...
                    <form @submit.prevent="submit" class="space-y-4">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <DatePicker v-model="form.start_date" label="Start Date" placeholder="Select Start" :error="form.errors.start_date" />
                            <DatePicker v-model="form.end_date" label="End Date" placeholder="Select End" :error="form.errors.end_date" />
                        </div>
