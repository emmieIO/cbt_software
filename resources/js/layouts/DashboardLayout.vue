            ...
            <header class="sticky top-0 z-50 flex h-20 shrink-0 items-center justify-between border-b border-slate-100 bg-white px-6 md:px-10">
                ...
                <div class="flex items-center gap-2 md:gap-4">
                    ...
                    <div class="relative" @click.stop>
                        ...
                        >
                            ...
                            <span
                                ...
                                class="absolute top-2.5 right-2.5 flex h-2 w-2 rounded-full bg-red-500 ring-2 ring-white"
                            ></span>
                        </button>
                        ...
                        >
                            ...
                            <div class="max-h-96 overflow-y-auto">
                                ...
                                <div
                                    ...
                                    :key="notification.id"
                                    class="border-b border-slate-50 p-5 transition-colors hover:bg-slate-50"
                                >
                    ...
                    <div class="relative ml-2 border-l border-slate-100 pl-6" @click.stop>
                        ...
                        >
                            <div
                                class="flex h-10 w-10 items-center justify-center rounded-full bg-slate-100 ring-2 ring-transparent transition-all group-hover:ring-primary/20"
                            >
