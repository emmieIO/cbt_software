...
<template>
    ...
    <div class="flex min-h-screen items-center justify-center bg-primary p-6 font-sans">
        <div class="w-full max-w-md space-y-8 rounded-xl bg-white p-8 shadow-2xl md:p-12">
            <!-- Header -->
            <div class="flex flex-col items-center text-center">
                ...
                <h1 class="mt-6 text-2xl font-bold text-slate-900">Student Portal</h1>
                <p class="mt-2 text-sm text-slate-600">Please enter your credentials to access your exam.</p>
            </div>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            placeholder="Enter Student ID or Admission No."
                        />
