...
<template>
    <StudentLayout>
        ...
        <div class="mx-auto max-w-3xl py-12">
            ...
            <div
                v-if="hasViolation"
                class="animate-in slide-in-from-top-4 mb-8 overflow-hidden rounded-2xl border-2 border-red-200 bg-red-50 p-6 shadow-lg"
            >
            ...
            <div class="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-2xl">
                ...
                <div class="bg-slate-900 p-12 text-center text-white">
                    ...
                    <p class="mt-2 text-xs font-bold tracking-widest text-slate-400 uppercase">Result Summary Generated</p>
                </div>
                ...
                <div class="p-12">
                    <div class="grid grid-cols-1 gap-10 md:grid-cols-2">
                        <div class="flex flex-col items-center justify-center rounded-2xl border-2 border-slate-50 bg-slate-50/30 p-10">
                            <span class="text-[10px] font-black tracking-[0.2em] text-slate-400 uppercase">Total Score</span>
                        ...
                        <div
                            class="flex flex-col items-center justify-center rounded-2xl border-2 p-10 transition-all"
                            :class="[statusBg, statusBorder]"
                        >
                            <span class="text-[10px] font-black tracking-[0.2em] uppercase" :class="statusColor">Percentage</span>
                            <div class="mt-4 flex items-baseline">
                    ...
                    <div class="mt-12 space-y-4">
                        <div class="flex items-center justify-between rounded-xl border border-slate-50 p-5">
                            <span class="text-xs font-black tracking-widest text-slate-400 uppercase">Subject</span>
                            <span class="text-sm font-black text-slate-800">{{ attempt.exam.subject.name }}</span>
                        </div>
                        <div class="flex items-center justify-between rounded-xl border border-slate-50 p-5">
                            <span class="text-xs font-black tracking-widest text-slate-400 uppercase">Exam Title</span>
                            <span class="text-sm font-black text-slate-800">{{ attempt.exam.title }}</span>
                        </div>
                        <div class="flex items-center justify-between rounded-xl border border-slate-50 p-5">
                            <span class="text-xs font-black tracking-widest text-slate-400 uppercase">Submission Time</span>
                    ...
                    <div class="mt-12 flex flex-col items-center">
                        <Link
                            ...
                            class="flex w-full items-center justify-center rounded-xl bg-primary py-5 text-sm font-black tracking-[0.2em] text-white uppercase shadow-xl shadow-primary/20 transition-all hover:scale-[1.02] active:scale-[0.98]"
                        >
                            Return to Dashboard
                        </Link>
                        <p class="mt-6 text-center text-xs leading-relaxed font-bold text-slate-400">
                            Your performance has been recorded. For further inquiries regarding this assessment, please contact your subject lead or
