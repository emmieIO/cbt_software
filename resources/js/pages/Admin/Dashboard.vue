        ...
        <div class="space-y-10">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-3">
                    <button
                        class="flex items-center gap-2 rounded-lg border border-slate-200 bg-white px-4 py-2 text-xs font-bold text-slate-600 uppercase shadow-sm transition-all hover:bg-slate-50 active:scale-95"
                    >
                    ...
                    <Link
                        ...
                        class="flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-xs font-bold text-white uppercase shadow-lg shadow-primary/20 transition-all hover:scale-105 active:scale-95"
                    >
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-4">
                <div class="rounded-xl bg-slate-900 p-8 text-white shadow-2xl transition-all hover:-translate-y-1">
                    ...
                    <p class="mt-4 text-4xl font-bold tracking-tighter text-white">
                ...
                <div class="rounded-xl border border-slate-100 bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl">
                    ...
                    <p class="mt-4 text-4xl font-bold tracking-tighter text-slate-800">
                        {{ stats.totalStaff.toLocaleString() }}
                    </p>
                </div>
                <div class="rounded-xl border border-slate-100 bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl">
                    <p class="text-[10px] font-bold tracking-widest text-slate-400 uppercase">Live Exams</p>
                    <p class="mt-4 text-4xl font-bold tracking-tighter text-green-600">
                        {{ stats.activeExams }}
                    </p>
                </div>
                <div class="rounded-xl border border-slate-100 bg-white p-8 shadow-sm transition-all hover:-translate-y-1 hover:shadow-xl">
                    ...
                    <div class="mt-4 flex items-center gap-3">
                        ...
                        <p class="text-3xl font-bold tracking-tighter text-blue-600 uppercase">{{ stats.systemStatus }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-hidden rounded-xl border border-slate-100 bg-white p-10 shadow-sm">
                <div class="mb-8 flex items-center justify-between">
                    <h3 class="text-xl font-bold tracking-tight text-slate-900">Recent System Logs</h3>
                    <span class="rounded-lg-full bg-slate-50 px-4 py-1.5 text-[10px] font-bold tracking-widest text-slate-400 uppercase"
                        >Live Monitor</span
                    >
                </div>
                <div class="divide-y divide-slate-50">
                    ...
                    >
                        ...
                        <span class="text-[10px] font-bold tracking-widest text-slate-300 uppercase">{{ activity.time }}</span>
                    </div>
                </div>
            </div>
        </div>
