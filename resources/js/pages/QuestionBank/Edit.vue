    ...
    <component :is="Layout">
        ...
        <div class="space-y-8 md:space-y-10">
            ...
            <nav class="flex items-center gap-2 text-[10px] font-bold tracking-widest text-slate-500 uppercase">
                ...
                <svg class="h-3 w-3 opacity-50" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M9 5l7 7-7 7" /></svg>
                <span class="text-slate-900">Modification</span>
            </nav>
                    ...
                    <div class="flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <div class="flex items-center gap-3">
                                ...
                                <h1 class="text-2xl md:text-3xl font-black tracking-tight text-slate-900 italic">Edit Question</h1>
                            </div>
                            <p class="mt-2 text-[10px] md:text-sm font-bold tracking-widest text-slate-400 uppercase px-1">Update content, metadata, or options.</p>
                        </div>
                    </div>
                </div>
