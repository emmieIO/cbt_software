...
<template>
    <StaffLayout>
        ...
        <div class="space-y-10">
            <!-- Header Section -->
            <div class="relative overflow-hidden rounded-[2.5rem] bg-slate-900 px-10 py-12 shadow-2xl shadow-slate-900/20">
                <div class="relative z-10">
                    <div class="mb-4 flex items-center gap-4">
                        <div
                            class="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-primary/20 text-lemon-yellow backdrop-blur-xl"
                        >
                ...
                <!-- Decorative Elements -->
                <div class="absolute -top-20 -right-20 h-64 w-64 rounded-full bg-primary/20 blur-3xl"></div>
                <div class="absolute right-20 -bottom-20 h-64 w-64 rounded-full bg-lemon-yellow/10 blur-3xl"></div>
            </div>
